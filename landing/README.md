...
O botão principal aponta ao instalador público `Titi-Setup-0.2.0-beta.9.exe` da versão `v0.2.0-beta.9`. A landing só deve ser publicada com essa versão depois que a release e os checksums finais existirem.
